    ...
    <div className="max-w-4xl mx-auto space-y-12 py-8">
      ...
      <div className="text-center space-y-6">
        ...
        <p className="text-xl text-slate-500 font-medium max-w-2xl mx-auto leading-relaxed">
          The Digital Headquarters for your career and college life. Owned and operated by <span className="text-blue-600 font-black">Oledge Group Pvt Ltd</span>. 
          We bridge the gap between students, government, and industry at <span className="font-black">oledge.online</span>.
        </p>
      </div>
      ...
      <div className="bg-blue-50 p-8 rounded-[2.5rem] border border-blue-100 flex items-center gap-6">
        ...
        <div>
          <h3 className="text-lg font-black text-slate-900 tracking-tight">Data Integrity & Compliance</h3>
          <p className="text-slate-600 text-sm font-medium leading-relaxed">
            We strictly follow the rule of government as data protection laws as per the Indian Govt. 
            Your data is utilized solely for your career growth. We value your trust above all else.
          </p>
        </div>
      </div>
      ...
      <div className="text-center py-12">
        <p className="text-slate-400 font-medium">© 2026 Oledge Group Pvt Ltd. All rights reserved.</p>
      </div>
    </div>
  );
}
