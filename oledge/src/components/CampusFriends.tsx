...
interface CampusFriendsProps {
  user: User;
}

export default function CampusFriends({ user }: CampusFriendsProps) {
    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm flex items-center justify-between">
        <div className="flex items-center gap-6">
          ...
          <div>
            <h2 className="text-3xl font-black text-slate-900 tracking-tight">Campus Friends</h2>
          ...
          <div className="space-y-4">
            ...
            {friends.length > 0 ? (
              <div className="grid sm:grid-cols-2 gap-4">
                {friends.map(friend => (
                  <div key={friend.uid} className="bg-white p-4 rounded-3xl border border-slate-100 shadow-sm flex items-center gap-4">
