  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h1 className="text-4xl font-black text-slate-900 tracking-tight mb-2">Campus Events</h1>
          <p className="text-slate-500 font-medium">Celebrate milestones, functions, and global celebrations.</p>
        </div>
        {canCreate && (
          <button 
